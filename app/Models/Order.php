...
{
    protected $fillable = [
        'client_id', 'order_type_id', 'order_status_id', 'montant', 'description',
        'justification', 'quantite', 'unite', 'priorite', 'progression',
        'date_soumission', 'traite_par',
    ];

    protected $casts = [
        'montant' => 'decimal:2', 'quantite' => 'decimal:2', 'date_soumission' => 'date',
    ];
